...
public class DenunciasPorVencerHolder extends RecyclerView.ViewHolder {
    ...
    public DenunciasPorVencerHolder(View view) {
        super(view);
    ...
    public void bind(Activity activity, final DataNotificacion notificacion, final DenunciasPorVencerAdapter.OnClickListener listener) {
